...
class Books extends Component {
    render() {
        return (
            <div className="card border-info mb-3 col-md-4 col-sm-1">
                ...
                <div className="card-body">
                    ...
                    <div><strong>{this.props.labels.BOOKNAME}</strong>: {this.props.bookName}</div>
                    <div><strong>{this.props.labels.BOOKTAG}</strong>: {this.props.bookTag}</div>
                    <div><strong>{this.props.labels.AUTOHR}</strong>: {this.props.authorName}</div>
                    <div><strong>{this.props.labels.EDITION}</strong>: {this.props.edition}</div>
